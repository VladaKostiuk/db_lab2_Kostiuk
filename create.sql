...
ALTER TABLE Years ADD CONSTRAINT PK_Years PRIMARY KEY (year_id);
...
ALTER TABLE Films ADD CONSTRAINT FK_Films_Years FOREIGN KEY (year_id) REFERENCES Years (year_id);